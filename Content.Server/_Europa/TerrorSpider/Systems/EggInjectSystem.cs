...
public sealed class EggInjectSystem : EntitySystem
{
    ...
    [
//        "TerrorSpiderEggQueen",
        "TerrorSpiderEggMother",
        "TerrorSpiderEggPrincess",
        "TerrorSpiderEggPrince",
        "TerrorSpiderEggDestroyer",
        "TerrorSpiderEggGuardian",
        "TerrorSpiderEggDefiler",
        "TerrorSpiderEggWidow",
        "TerrorSpiderEggReaper",
        "TerrorSpiderEggDrone",
        "TerrorSpiderEggHealer",
        "TerrorSpiderEggLurker",
        "TerrorSpiderEggKnight"
    ];
    ...
    {
        if (_eggs.Any(egg => egg == args.Egg) && TryComp(uid, out ActorComponent? actor))
        {
